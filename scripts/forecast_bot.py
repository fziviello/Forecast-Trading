...
def startForecast():
    global SYMBOL, SYMBOL_FILTER, MODEL_PATH, SCALER_PATH, FORECAST_RESULTS_PATH, VALIDATION_RESULTS_PATH, PLOT_FILE_PATH, PLOT_MODEL_FILE_PATH, DATASET_PATH, BASE_CURRENCY, EXCHANGE_RATE
